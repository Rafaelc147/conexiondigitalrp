...
<head>
    ...
    <title>Digital RP | Componentes y Periféricos</title>
...
<body>
    ...
    <script>
        // Datos de productos de componentes y periféricos
        ...
        // Cargar productos de componentes
        ...
        function agregarAlCarrito(id) {
            const producto = productosComponentes.find(p => p.id === id);
            if (producto) {
