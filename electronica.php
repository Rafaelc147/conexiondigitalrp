...
<head>
    ...
    <title>Digital RP | Electrónica</title>
...
<body>
    ...
    <section class="featured">
        <div class="featured-container">
            <h2 class="section-title">Electrónica</h2>
    ...
    <a href="https://wa.me/573001234567?text=Hola,%20estoy%20interesado%20en%20sus%20productos%20de%20electrónica" class="whatsapp-float" target="_blank">
        📱
    </a>
    ...
    <script>
        // Datos de productos de electrónica
        const productosElectronica = [
            // Aquí puedes agregar productos de electrónica
        ];
        ...
        function cargarProductosElectronica() {
            ...
            if (productosElectronica.length === 0) {
        ...
        function agregarAlCarrito(id) {
            const producto = productosElectronica.find(p => p.id === id);
            if (producto) {
